        ...
        <div class="content_Admin">
            ...
            <div class="container_content">
                <div class="content_Admin_List">
                    ...
                    <a href="/Project_WebBanHang/Template-Views/Admin/Product/ProductDeleted.php" class="btn-delete">Sản
                        phẩm đã xoá</a>
                    <?php
                    if ($lengthProduct > 0) {
                        ?>
                        <table id="customers">
                            ...
                            for ($i = 0; $i < $lengthProduct; $i++) {
                                ...
                                <tr>
                                    <td>
                                        <?php echo $listProduct[$i]->getPrID() ?>
                                    </td>
                                    <td>
                                        <?php echo $listProduct[$i]->getPrName() ?>
                                    </td>
                                    <td>
                                        <?php echo $listProduct[$i]->getQuantity() ?>
                                    </td>
                                    <td>
                                        <?php echo $listProduct[$i]->getColor() ?>
                                    </td>
                                    <td>
                                        <?php echo $listProduct[$i]->getSize() ?>
                                    </td>
                                    <td><img class="img_product"
                                            src="/Project_WebBanHang/Upload/img/<?php echo $listProduct[$i]->getImg() ?>"></td>
                                    <td>
                                        <?php echo $listProduct[$i]->getPrice() ?>
                                    </td>
                                    <td>
                                        <div class="icon_thaotac">
                                            <div class="item-edit">
                                                <a title="Chi tiết"
                                                    href="/Project_WebBanHang/Action-Controller/ProductController/DetailProduct_action.php?id=<?php echo $listProduct[$i]->getPrID(); ?>"
                                                    class="btn mx-1">
                                            ...
                                            <div class="item-edit">
                                                <a title="Chỉnh sửa"
                                                    href="/Project_WebBanHang/Action-Controller/ProductController/GetInfoProduct_action.php?id=<?php echo $listProduct[$i]->getPrID(); ?>"
                                                    class="btn mx-1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <div class="item-edit">
                                                <a onclick="openModal(<?php echo $listProduct[$i]->getPrID(); ?>)" title="Xoá"
                    ...
                    <ul class="pagination">
                        ...
                        for ($i = 1; $i <= $total_pages; $i++) {
                            ...
                            <li class="page-item" <?php if ($i == $page)
                                echo "class='active'"; ?>><a
                                    href="?pI=<?php echo $i; ?>" class="page-link text-dark "><?php echo $i; ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
            ...
            <form method="post" enctype="multipart/form-data"
                ...
                <div class="details">
                    ...
                    <div class="Price">
                        ...
                        <div class="content"> <input class="Input" type="number" id="price" name="ProductPrice"
                                required /></div>
                    </div>
                    <div class="Quanti">
                        <div class="label"> <label>Số lượng</label></div>
                        <div class="content"> <input class="Input" type="number" id="quantity" name="ProductQuantity"
                                required /></div>
                    </div>
                    <div class="Size">
                        <div class="label"> <label>Kích cỡ</label></div>
                        <div class="content"> <input class="Input" type="text" id="size" name="ProductSize" required />
                        </div>
                    </div>
                    <div class="Col">
                    ...
                    <div class="Des">
                        ...
                        <div class="content"> <textarea class="Input" type="text" id="description"
                                name="ProductDescription" required></textarea></div>
                    </div>
                    <div class="Ima">
                        ...
                        <div class="content"> <img id="output" style="width:200px;height:200px;object-fit:cover;" />
                        </div>
                    </div>
                    <div class="ImaDes">
