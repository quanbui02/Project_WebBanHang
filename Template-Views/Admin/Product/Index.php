                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icon_thaotac">
                                            ...
                                            <div class="item-edit">
                                                <a title="Xoá" href="/Project_WebBanHang/Action-Controller/ProductController/DeleteProduct_action.php?id=<?php echo $listProduct[$i]->getPrID(); ?>" class="btn mx-1" style="cursor:pointer;">
