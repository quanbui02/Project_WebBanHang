                ...
                <div class="content_Admin">
                    ...
                    ?>
                        <table id="customers">
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $lengtProduct[$i]->getPrID() ?></td>
                                    <td><?php echo $lengtProduct[$i]->getPrName() ?></td>
                                    <td><?php echo $lengtProduct[$i]->getQuantity() ?></td>
                                    <td><?php echo $lengtProduct[$i]->getColor() ?></td>
                                    <td><?php echo $lengtProduct[$i]->getSize() ?></td>
                                    <td><?php echo $lengtProduct[$i]->getPrice() ?></td>
                                    <td>
                                        <div class="icon_thaotac">
                                            <div class="item-edit">
                                                <a href="/Project_WebBanHang/Action-Controller/ProductController/DetailProduct_action.php?id=<?php echo $lengtProduct[$i]->getPrID(); ?>" class="btn mx-1">
                                            ...
                                            <div class="item-edit">
                                                <a href="/Project_WebBanHang/Action-Controller/ProductController/UndoProduct_action.php?id=<?php echo $lengtProduct[$i]->getPrID(); ?>" class="btn mx-1">
