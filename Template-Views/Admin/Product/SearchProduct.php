                        ...
                        <tr>
                            ...
                            <td>
                                <div class="icon_thaotac">
                                    <div class="item-edit">
                                        <a href="/Project_WebBanHang/Action-Controller/ProductController/DetailProduct_action.php?id=<?php echo $listProductSearch[$i]->getPrID(); ?>"
                                            class="btn mx-1">
                                    ...
                                    <div class="item-edit">
                                        <a href="/Project_WebBanHang/Action-Controller/ProductController/GetInfoProduct_action.php?id=<?php echo $listProductSearch[$i]->getPrID(); ?>"
                                            class="btn mx-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div class="item-edit">
                                        <a onclick="openModal(<?php echo $listProductSearch[$i]->getPrID(); ?>)"
                                            title="Xoá" class="btn mx-1" style="cursor:pointer;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
