...
include_once "C:/xampp/htdocs/Project_WebBanHang/DAO/FeedbackDAO.php";
session_start();
$listFeedback = getListFeedback();
$total_pages = getIndexPageFeedback();
$page = isset($_GET['pI']) ? $_GET['pI'] : 1;
$lengthFeedback = count($listFeedback);
echo $lengthFeedback
?>
        ...
        <div class="side-nav">
            <div class="side-nav-inner">
                <ul class="side-nav-menu scrollable">
                    ...
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle" href="/Project_WebBanHang/Template-Views/Admin/Feedback/index.php">
                            <span class="icon-holder">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icon_thaotac">
                                            ...
                                            <div class="item-edit">
                                                <a href="" class="btn mx-1" style="cursor:pointer;">
