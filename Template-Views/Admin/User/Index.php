...
<body>
    <div class="container_flex">
        ...
        <div class="content_Admin">
            <form class="search" action="/Project_WebBanHang/Action-Controller/UserController/SearchProduct_action.php">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="icon_thaotac">
                                            ...
                                            <div class="item-edit">
                                                <a href="/Project_WebBanHang/Action-Controller/UserController/DeleteUser_action.php?id=<?php echo $listUser[$i]->getUserID(); ?>" class="btn mx-1" style="cursor:pointer;">
