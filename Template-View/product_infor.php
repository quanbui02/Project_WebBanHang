...
<html>
    ...
    <body>
                ...
                <button>
                    <?php 
                      if($_SESSION["product"]->getQuantity()>0){
                        ?>
                        <a href="<?php echo "/GhepCode/Action-Controler/add_cart_action.php?id_product=".$_SESSION["product"]->getPrID(); ?>">Thêm vào giỏ hàng</a>
                        <?php
                      }else{
                        ?>
        ...
        <div class="fb-input">
            <form action="<?php echo "/GhepCode/Action-Controler/add_fb_action.php"; ?>">
