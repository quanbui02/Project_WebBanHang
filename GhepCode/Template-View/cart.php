        ...
        <?php
            if(empty($error)){
                ...
                <div class="order-details">
                    ...
                    for($i =0;$i<count($cartDetailOrder);$i++){
                        ...
                        <div class="item">
                            ...
                            <div class="quantity">
                                 Số lượng:
                                <button><a href="<?php echo "/Project_WebBanHang/GhepCode/Action-Controler/stonk_order_detail.php?id_product=".$cartDetailOrder[$i]->getProID()."&id_detail=".$cartDetailOrder[$i]->getDetailID()."&number=".$cartDetailOrder[$i]->getNumber(); ?>">+</a></button>
                                <?php echo $cartDetailOrder[$i]->getNumber(); ?>
                                <button><a href="<?php echo "/Project_WebBanHang/GhepCode/Action-Controler/notStonk_order_detail.php?id_product=".$cartDetailOrder[$i]->getProID()."&id_detail=".$cartDetailOrder[$i]->getDetailID()."&number=".$cartDetailOrder[$i]->getNumber(); ?>">-</a></button>
                                <button><a href="<?php echo "/Project_WebBanHang/GhepCode/Action-Controler/destroy_order_detail.php?id_product=".$cartDetailOrder[$i]->getProID()."&id_detail=".$cartDetailOrder[$i]->getDetailID()."&number=".$cartDetailOrder[$i]->getNumber(); ?>">x</a></button>
                            </div>
                ...
                <div class="purchase">
                    ...
                    <button><a href="/Project_WebBanHang/GhepCode/Template-View/trangchu.php?search=">Trở về trang chủ</a></button>
                </div>
                <?php
            }else{
                echo "<p>".$error."</p>";
